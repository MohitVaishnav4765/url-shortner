...
<div class="tab-content" id="myTabContent">
  <div class="tab-pane fade {{ $tab == 'users' ? 'show active':'' }}" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
    <div>
        <button class="btn btn-primary float-end" id="invite-client">Invite Users</button>
    </div>
  ...
  <div class="tab-pane fade {{ $tab == 'urls' ? 'show active':'' }}" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
    <div>
